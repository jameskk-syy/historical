...
function IndividualAff() {
  ...
  return (
    <>
      ...
      >
        <main className="pt-6 -mt-2 font-abc">
          <div className="mx-auto p-2">
            <div className="flex flex-wrap flex-row">
              <div className="flex-shrink  max-w-full  w-full w-full md:mr-10 lg:mr-20 mb-6">
                <div className="p-2 md:p-6 bg-card rounded-lg shadow-lg mb-6">
                  <p className="text-lg font-semibold mt-3 mb-5 text-card3 font-abc">
