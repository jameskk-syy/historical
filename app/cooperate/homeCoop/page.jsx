...
import CoopNav from "@/app/components/CoopNav";
  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: "url('/coopBG.png')" }}
      >
        <CoopNav />
        <div className="flex justify-start ml-10  items-center h-screen bg-fixed bg-center bg-cover">
