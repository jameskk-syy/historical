...
const  router =  useRouter();
  ...
  useEffect(()=>{
    let cooperativeIds = localStorage.getItem('registrationNumber');
    async function fetchProducts(){
      const  response  =  await axios.get('https://us-central1-farmfuzion.cloudfunctions.net/loan_products');
      setFetchedLoans(response.data.loans)
  ...
  try {
    ...
    const response = await axios.post('https://us-central1-farmfuzion.cloudfunctions.net/loan_products', JSON.stringify(loanData), {
      headers: {
  ...
  return (
    ...
    <div className="container md:mx-auto pt-2">
      ...
      {activeStep === 'createLoan' && (
        <div className="flex flex-wrap  justify-center md:ml-20 md:mx-auto">
